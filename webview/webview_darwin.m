...
NSLog(message.body);
g_vui_webview_js_val = builtin__ctovstring([message.body UTF8String]);
//                 *resultt = builtin__ctovstring([result UTF8String]);
}
@end
...
//                 *resultt = builtin__ctovstring([result UTF8String]);
g_vui_webview_js_val = builtin__ctovstring([result UTF8String]);
               }
             }];
